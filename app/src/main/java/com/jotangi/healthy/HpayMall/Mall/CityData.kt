 ...
 */
/*地址Information 頁面*/
class CityData private constructor() {
    companion object {
        val instance = CityData()
    }

    var counties = arrayOf(
        "臺北市", "新北市", "桃園市", "新竹縣", "新竹市",
