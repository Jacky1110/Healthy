...
import com.jotangi.healthy.BuildConfig;
import com.jotangi.healthy.HpayMall.CustomDaialog;
import com.jotangi.healthy.R;
import com.jotangi.healthy.ui.customview.MaskView;
    ...
    protected void onResume() {
        ...
        if (bitmap == null) {
          runOnUiThread(new Runnable() {
              @Override
              public void run() {
                  CustomDaialog.showthree(CropHeadImageActivity.this, "", "", "", new CustomDaialog.OnBtn3ClickListener() {
