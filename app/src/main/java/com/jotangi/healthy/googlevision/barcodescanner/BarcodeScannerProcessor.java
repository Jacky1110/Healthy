...
package com.jotangi.healthy.googlevision.barcodescanner;
...
import com.jotangi.healthy.googlevision.GraphicOverlay;
import com.jotangi.healthy.googlevision.VisionProcessorBase;
...
public class BarcodeScannerProcessor extends VisionProcessorBase<List<Barcode>> {
    ...
    protected void onSuccess(
        ...
        for (int i = 0; i < barcodes.size(); ++i) {
            ...
            MemberBean.barcode = barcode.getRawValue();
